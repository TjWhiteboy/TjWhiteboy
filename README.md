...
- 🎓 Pursuing **B.E. Computer Science (AI & Machine Learning)**, Tamil Nadu, India
- 🤖 Building AI-powered products end-to-end — from model to production
- 🌱 Currently learning **Agentic AI**, **LLMs**, **RAG**, **AWS AI**, **Multi-Agent Systems**, **OpenCV**
- 🚀 Looking for **AI/ML internships**, **research collaboration**, and **hackathons**
- 📝 **IEEE published author** — Artificial Intelligence & Computer Vision in Medical Imaging
- 💬 Ask me about **Python**, **React**, **Node.js**, **TensorFlow**, **OpenCV**, **Generative AI**
